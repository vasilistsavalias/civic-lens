...
Purpose: Central entrypoint for modular project documentation.
Audience: Both
...
- Run `pytest` and `streamlit run app.py` after reading architecture/testing docs.

## Common Failure Modes
- Missing links after doc refactors.
- Commands changed in code but not mirrored in docs.
